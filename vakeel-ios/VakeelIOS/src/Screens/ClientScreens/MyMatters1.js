...
export default function MyMatters1({navigation}) {
  ...
  useEffect(() => {
    getMattersCategories('all');
    fetchCardData('all');
  }, []);

  const getMattersCategories = async () => {
    let obj = {
      limit: 1000,
      only_parent:true
    };
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      <ImageBackground
        ...
        <AppHeader navigation={navigation} title="My Legal Matters" />
