...
export default function PostCase1({ navigation }) {
    ...
    useEffect(() => {
        ...
        const fetchCategories = async () => {
            try {
                const response = await fetch(`${urls.LiveBaseUrl}${endpoints.getCasesCategories}`);
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            >
                <AppHeader navigation={navigation} title="Add Case" progress="1/3" />
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            if (selectedCategory) {
                                ...
                                // });
                                navigation.navigate('PostCases2', {
                                    category_id: selectedCategory?.id,
                                     subcategories:selectedCategory?.subcategories
                                    // subcategories:boxData
                                })
                            }
                        }}
